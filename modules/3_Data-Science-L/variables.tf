...
variable "zone" {
  ...
  description = "yongsh_test_customization_ds: Cloud Zone associated to the AI Notebooks. {{UIMeta group=0 order=3 options=asia-southeast1-a,asia-southeast1-b,asia-southeast1-c }}"
  type        = string
