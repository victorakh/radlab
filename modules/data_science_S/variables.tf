...
variable "project_id_prefix" {
  ...
  type        = string
  default     = "radlab-data-science-s-7a22"
}
...
variable "zone" {
  description = "Cloud Zone associated to the AI Notebooks. {{UIMeta group=2 order=3 options=asia-southeast1,us-central1-b,us-east1-a,us-west3-b,us-east4-c }}"
  type        = string
