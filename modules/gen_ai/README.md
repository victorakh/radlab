...
| workbench_googlemanaged_names | Google Managed Notebook Instance Names |  |
| workbench_googlemanaged_urls | Google Managed Notebook access URLs |  |
| workbench_usermanaged_names | User Managed Notebook Instance Names |  |
| workbench_usermanaged_urls | User managed notebook access URLs |  |
